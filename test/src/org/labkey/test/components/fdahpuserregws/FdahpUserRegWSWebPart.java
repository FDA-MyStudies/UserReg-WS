...
package org.labkey.test.components.fdahpuserregws;
 ...
 */
public class FdahpUserRegWSWebPart extends BodyWebPart<FdahpUserRegWSWebPart.ElementCache>
{
    public FdahpUserRegWSWebPart(WebDriver driver)
    {
        this(driver, 0);
    }

    public FdahpUserRegWSWebPart(WebDriver driver, int index)
    {
        super(driver, "FdahpUserRegWS", index);
    }

    public FdahpUserRegWSWebPart setInput(String value)
    {
